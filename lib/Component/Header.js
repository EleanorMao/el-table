    ...
    _createClass(Header, [{
        ...
        value: function colgroupRender(renderChildren, selectRow, left, right) {
            ...
            return _react2['default'].createElement(
                ...
                selectRow && selectRow.mode && selectRow.mode !== 'none' && !selectRow.hideSelectColumn && _react2['default'].createElement('col', { key: 'select', style: { textAlign: 'center', width: 46 } }),
