...
var NestedHeader = function (_Component) {
    ...
    _createClass(NestedHeader, [{
        ...
        value: function nestedHeadRender() {
            ...
            var select = selectRow && selectRow.mode && selectRow.mode !== 'none';
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                { className: "el-table table-nestedHead " + this.props.lineWrap, ref: function ref(c) {
                        return _this2._header = c;
                    } },
